...
<head>
    ...
    <title>Adote 1 amigo.com.br - Admin</title>
</head>
...
<body>
    ...
    auth()->user()->can('Listar Empresas'))
                            ...
                            <li
                                ...
                                @if (isset(Auth::user()->company->id))
                                    <a class="icon-building"
                                        href="{{ route('admin.companies.edit', ['company' => Auth::user()->company->id]) }}">ONG</a>
                                @else
                                    <a class="icon-building" href="{{ route('admin.companies.create') }}">ONG</a>
                                @endif
                            @else
                            <li
                                class="dash_sidebar_nav_item  {{ isActive('admin.users') }} {{ isActive('admin.companies') }}">
                                ...
                                <ul class="dash_sidebar_nav_submenu">
                                    ...
                                    @can('Listar Empresas')
                                        <li class="{{ isActive('admin.companies.index') }}"><a
                                                href="{{ route('admin.companies.index') }}">ONGs</a></li>
                                    @endcan
                        ...
                        @can('Listar Animais')
                            {{-- Menu Animais --}}
                            <li class="dash_sidebar_nav_item {{ isActive('admin.animals') }}">
                                <a class="icon-heart" href="javascript:void(0)">Animais</a>
                                <ul class="dash_sidebar_nav_submenu">
                                    @can('Listar Animais')
                                        <li class="{{ isActive('admin.animals.index') }}"><a
                                                href="{{ route('admin.animals.index') }}">Ver Todos</a></li>
                                    @endcan
                                    @can('Cadastrar Animais')
                                        <li class="{{ isActive('admin.animals.create') }}"><a
                                                href="{{ route('admin.animals.create') }}">Criar Novo</a></li>
                                    @endcan
                                </ul>
                            </li>
                        @endcan
