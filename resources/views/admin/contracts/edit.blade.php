                ...
                <div class="nav_tabs_content">
                    <div id="parts">
                        <form action="{{ route('admin.contracts.update', ['contract' => $contract]) }}" method="post"
                            ...
                            <input type="hidden" name="automotive_persist"
                                value="{{ old('automotive') ?? $contract->automotive }}">
                            ...
                            <label class="label">
                                ...
                                <select name="status" class="select2">
                                    <option value="pending"
                                        {{ old('status') === 'pending' ? 'selected' : ($contract->status === 'pending' ? 'selected' : '') }}>
                                        Pendente</option>
                                    <option value="active"
                                        {{ old('status') === 'active' ? 'selected' : ($contract->status === 'active' ? 'selected' : '') }}>
                                        Ativo</option>
                                    <option value="canceled"
                                        {{ old('status') === 'canceled' ? 'selected' : ($contract->status === 'canceled' ? 'selected' : '') }}>
                                        Cancelado</option>
                                </select>
                            </label>
                                        ...
                                        <label class="label">
                                            ...
                                            <select class="select2" name="owner"
                                                ...
                                                @foreach ($sellers->get() as $seler)
                                                    <option value="{{ $seler->id }}"
                                                        {{ old('owner') == $seler->id ? 'selected' : ($contract->owner == $seler->id ? 'selected' : '') }}>
                                                        {{ $seler->name }}
                                                        ({{ $seler->document }})
                                                    </option>
                                                @endforeach
                                            ...
                                            <select name="acquirer" class="select2"
                                                ...
                                                @foreach ($buyers->get() as $buyer)
                                                    <option value="{{ $buyer->id }}"
                                                        {{ old('acquirer') == $buyer->id ? 'selected' : ($contract->acquirer == $buyer->id ? 'selected' : '') }}>
                                                        {{ $buyer->name }}
                                                        ({{ $buyer->document }})
                                                    </option>
                                                @endforeach
                                    ...
                                    <div class="label_g2">
                                        <label class="label">
                                            ...
                                            <select name="due_date" class="select2">
                                                <option value="1"
                                                    {{ old('due_date') == 1 ? 'selected' : ($contract->due_date == 1 ? 'selected' : '') }}>
                                                    1º
                                                </option>
                                                <option value="2"
                                                    {{ old('due_date') == 2 ? 'selected' : ($contract->due_date == 2 ? 'selected' : '') }}>
                                                    2/mês
                                                </option>
                                                <option value="3"
                                                    {{ old('due_date') == 3 ? 'selected' : ($contract->due_date == 3 ? 'selected' : '') }}>
                                                    3/mês
                                                </option>
                                                <option value="4"
                                                    {{ old('due_date') == 4 ? 'selected' : ($contract->due_date == 4 ? 'selected' : '') }}>
                                                    4/mês
                                                </option>
                                                <option value="5"
                                                    {{ old('due_date') == 5 ? 'selected' : ($contract->due_date == 5 ? 'selected' : '') }}>
                                                    5/mês
                                                </option>
                                                <option value="6"
                                                    {{ old('due_date') == 6 ? 'selected' : ($contract->due_date == 6 ? 'selected' : '') }}>
                                                    6/mês
                                                </option>
                                                <option value="7"
                                                    {{ old('due_date') == 7 ? 'selected' : ($contract->due_date == 7 ? 'selected' : '') }}>
                                                    7/mês
                                                </option>
                                                <option value="8"
                                                    {{ old('due_date') == 8 ? 'selected' : ($contract->due_date == 8 ? 'selected' : '') }}>
                                                    8/mês
                                                </option>
                                                <option value="9"
                                                    {{ old('due_date') == 9 ? 'selected' : ($contract->due_date == 9 ? 'selected' : '') }}>
                                                    9/mês
                                                </option>
                                                <option value="10"
                                                    {{ old('due_date') == 10 ? 'selected' : ($contract->due_date == 10 ? 'selected' : '') }}>
                                                    10/mês
                                                </option>
                                                <option value="11"
                                                    {{ old('due_date') == 11 ? 'selected' : ($contract->due_date == 11 ? 'selected' : '') }}>
                                                    11/mês
                                                </option>
                                                <option value="12"
                                                    {{ old('due_date') == 12 ? 'selected' : ($contract->due_date == 12 ? 'selected' : '') }}>
                                                    12/mês
                                                </option>
                                                <option value="13"
                                                    {{ old('due_date') == 13 ? 'selected' : ($contract->due_date == 13 ? 'selected' : '') }}>
                                                    13/mês
                                                </option>
                                                <option value="14"
                                                    {{ old('due_date') == 14 ? 'selected' : ($contract->due_date == 14 ? 'selected' : '') }}>
                                                    14/mês
                                                </option>
                                                <option value="15"
                                                    {{ old('due_date') == 15 ? 'selected' : ($contract->due_date == 15 ? 'selected' : '') }}>
                                                    15/mês
                                                </option>
                                                <option value="16"
                                                    {{ old('due_date') == 16 ? 'selected' : ($contract->due_date == 16 ? 'selected' : '') }}>
                                                    16/mês
                                                </option>
                                                <option value="17"
                                                    {{ old('due_date') == 17 ? 'selected' : ($contract->due_date == 17 ? 'selected' : '') }}>
                                                    17/mês
                                                </option>
                                                <option value="18"
                                                    {{ old('due_date') == 18 ? 'selected' : ($contract->due_date == 18 ? 'selected' : '') }}>
                                                    18/mês
                                                </option>
                                                <option value="19"
                                                    {{ old('due_date') == 19 ? 'selected' : ($contract->due_date == 19 ? 'selected' : '') }}>
                                                    19/mês
                                                </option>
                                                <option value="20"
                                                    {{ old('due_date') == 20 ? 'selected' : ($contract->due_date == 20 ? 'selected' : '') }}>
                                                    20/mês
                                                </option>
                                                <option value="21"
                                                    {{ old('due_date') == 21 ? 'selected' : ($contract->due_date == 21 ? 'selected' : '') }}>
                                                    21/mês
                                                </option>
                                                <option value="22"
                                                    {{ old('due_date') == 22 ? 'selected' : ($contract->due_date == 22 ? 'selected' : '') }}>
                                                    22/mês
                                                </option>
                                                <option value="23"
                                                    {{ old('due_date') == 23 ? 'selected' : ($contract->due_date == 23 ? 'selected' : '') }}>
                                                    23/mês
                                                </option>
                                                <option value="24"
                                                    {{ old('due_date') == 24 ? 'selected' : ($contract->due_date == 24 ? 'selected' : '') }}>
                                                    24/mês
                                                </option>
                                                <option value="25"
                                                    {{ old('due_date') == 25 ? 'selected' : ($contract->due_date == 25 ? 'selected' : '') }}>
                                                    25/mês
                                                </option>
                                                <option value="26"
                                                    {{ old('due_date') == 26 ? 'selected' : ($contract->due_date == 26 ? 'selected' : '') }}>
                                                    26/mês
                                                </option>
                                                <option value="27"
                                                    {{ old('due_date') == 27 ? 'selected' : ($contract->due_date == 27 ? 'selected' : '') }}>
                                                    27/mês
                                                </option>
                                                <option value="28"
                                                    {{ old('due_date') == 28 ? 'selected' : ($contract->due_date == 28 ? 'selected' : '') }}>
                                                    28/mês
                                                </option>
                                            </select>
                                        </label>
                                        ...
                                        <label class="label">
                                            ...
                                            <select name="deadline" class="select2">
                                                <option value="12"
                                                    {{ old('deadline') == 12 ? 'selected' : ($contract->deadline == 12 ? 'selected' : '') }}>
                                                    12
                                                    meses
                                                </option>
                                                <option value="24"
                                                    {{ old('deadline') == 24 ? 'selected' : ($contract->deadline == 24 ? 'selected' : '') }}>
                                                    24
                                                    meses
                                                </option>
                                                <option value="36"
                                                    {{ old('deadline') == 36 ? 'selected' : ($contract->deadline == 36 ? 'selected' : '') }}>
                                                    36
                                                    meses
                                                </option>
                                                <option value="48"
                                                    {{ old('deadline') == 48 ? 'selected' : ($contract->deadline == 48 ? 'selected' : '') }}>
                                                    48
                                                    meses
                                                </option>
                                            </select>
                    ...
                    <div id="terms" class="d-none">
                        ...
                        <textarea name="terms" cols="30" rows="10"
                            class="mce">{{ $contract->terms() }}</textarea>
                    </div>
                </div>
            </div>
        </div>
            ...
            function setFieldOwner(response) {
                ...
                if (response.spouse) {
                    ...
                    $('select[name="owner_spouse"]').append($('<option>', {
                        ...
                        selected: ($('input[name="owner_spouse_persist"]').val() != 0 ? 'selected' :
                            false)
                    }));
                } else {
                    $('select[name="owner_spouse"]').append($('<option>', {
                    ...
                    $.each(response.companies, function(key, value) {
                        $('select[name="owner_company"]').append($('<option>', {
                            ...
                            selected: ($('input[name="owner_company_persist"]').val() != 0 && $(
                                    'input[name="owner_company_persist"]').val() == value
                                .id ? 'selected' : false)
                        }));
                    });
                ...
                if (response.properties != null && response.properties.length) {
                    ...
                    $.each(response.properties, function(key, value) {
                        $('select[name="automotive"]').append($('<option>', {
                            ...
                            selected: ($('input[name="automotive_persist"]').val() != 0 && $(
                                    'input[name="automotive_persist"]').val() == value.id ?
                                'selected' : false)
                        }));
                    });
            ...
            function setFieldAcquirer(response) {
                ...
                if (response.spouse) {
                    ...
                    $('select[name="acquirer_spouse"]').append($('<option>', {
                        value: 1,
                        text: response.spouse.spouse_name + '(' + response.spouse.spouse_document + ')',
                        selected: ($('input[name="acquirer_spouse_persist"]').val() != 0 ? 'selected' :
                            false)
                    }));
                } else {
                    $('select[name="acquirer_spouse"]').append($('<option>', {
                    ...
                    $.each(response.companies, function(key, value) {
                        $('select[name="acquirer_company"]').append($('<option>', {
                            ...
                            selected: ($('input[name="acquirer_company_persist"]').val() != 0 &&
                                $('input[name="acquirer_company_persist"]').val() == value
                                .id ? 'selected' : false)
                        }));
                    });
