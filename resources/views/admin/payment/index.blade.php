        ...
        <section class="dash_content_app">
            ...
            <div class="dash_content_app_box">
                <div class="text-center py-2 bg-orange radius">
                    <p style="color: #fff; padding: 20px;">O prazo de ativação dos créditos para anúncios é de até 24h após
                        a confirmação de pagamento</p>
                </div>
                <section>
                    <div class="dash_content_app_box">
            ...
            <div class="text-left py-2">
                ...
                <p>ONG virtual básica (30 dias) = GRÁTIS</p>
                <p>ONG virtual TOP (30 dias) = R$ 3,00</p>
