                ...
                <div class="row">
                                ...
                                @if ($automotive->images()->get()->count() > 1)
                                    @foreach ($automotive->images()->get() as $image)
                                        <li data-target="#carouselProperty" data-slide-to="{{ $loop->iteration - 1 }}"
                                            ...
                                            style="width: 100%; max-height: 150px; display: flex; justify-content: center;">
                                            <img src="{{ $image->getUrlCroppedAttribute() }}"
                    ...
                    <div class="col-12 col-lg-4 mt-3 mt-lg-0">
                        ...
                        <a target="_blank"
                            ...
                            class="btn btn-success btn-lg btn-block icon-whatsapp mb-3">Converse com o Anunciante!
                        </a>
                            ...
                            <form action="{{ route('web.sendEmail') }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="message" id="message" cols="30" rows="5" class="form-control"
                                        required>Quero ter mais informações sobre o animal {{ $automotive->title }}.</textarea>
                                </div>
