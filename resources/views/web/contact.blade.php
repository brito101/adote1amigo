...
@section('content')
    <div class="main_contact py-5 bg-light text-center">
        <div class="container">
            ...
            <p class="mb-0">Quer conversar com um corretor exclusivo e ter o atendimento diferenciado para
                <b>anunciar</b> ou
                <b>encontrar</b> o seu amiguinho dos seus sonhos?
            </p>
            ...
            <div class="row text-left">
                <form action="{{ route('web.sendEmail') }}" method="post">
                    ...
                    <div class="form-group">
                        <textarea name="message" rows="5" class="form-control" placeholder="Escreva sua mensagem..."
                            required></textarea>
                    </div>
        ...
        <div class="container">
            <div class="row text-center">
                <div class="col-12 col-md-4">
                    ...
                    <p class="pt-2"><a href="mailto:contato@rodrigobrito.dev.br"
                            class="text-front">ufrrj99@gmail.com</a></p>
                </div>
